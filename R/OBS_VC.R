#' Find and test change points in connection network by VCCP (OBS) model
#'
#' \code{VC_OBS} returns a dataframe containing the inference result
...
#'  change points. This parameter is vital for the Old Binary Segmentation (OBS) method
